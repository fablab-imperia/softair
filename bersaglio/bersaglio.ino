...
#define SOGLIA 600                              // Questo è da scegliere a seconda del sensore come nel video che mi hai condiviso
...
#define NUMERO_BERSAGLI 2

const short int ledPins[5] = {6, 7, 8, 9, 10};  // I pin a cui sono collegati i led (in quest'ordine, nel senso che il primo ad accendersi è sul pin 2, poi 3, ecc...)
unsigned long ultimoTempoDebounce = 0;
short int n_led = 0;

void accendiLed(short int n){                   // Funzione per accendere i primi n led
  for (short int i = 0; i < NUMERO_BERSAGLI; i++){
...
void setup(){
  ...
  for (int i = 0; i < NUMERO_BERSAGLI; i++){
